...
# python3 ./src/GFA/create_description_file.py $ref_data_dir $pheno_sample_out $description
...
then
    ...
    Rscript ./src/GFA/2_input_snp_list.R $zmat_combined $snp_path $zmat_pruned
fi
